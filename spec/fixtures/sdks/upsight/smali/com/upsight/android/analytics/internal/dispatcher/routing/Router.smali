...
# static fields
.field public static final PACKET_ROUTE_ERROR:Ljava/lang/String; = "Failed to route packet"
...
.method static synthetic access$000(Lcom/upsight/android/analytics/internal/dispatcher/routing/Router;Lcom/upsight/android/analytics/internal/dispatcher/routing/Packet;)V
    .locals 0
    .param p0, "x0"    # Lcom/upsight/android/analytics/internal/dispatcher/routing/Router;
    .param p1, "x1"    # Lcom/upsight/android/analytics/internal/dispatcher/routing/Packet;

    .prologue
    .line 21
    invoke-direct {p0, p1}, Lcom/upsight/android/analytics/internal/dispatcher/routing/Router;->nextRouteStep(Lcom/upsight/android/analytics/internal/dispatcher/routing/Packet;)V

    return-void
.end method

.method static synthetic access$100(Lcom/upsight/android/analytics/internal/dispatcher/routing/Router;)Lcom/upsight/android/analytics/internal/dispatcher/routing/RoutingListener;
    .locals 1
    .param p0, "x0"    # Lcom/upsight/android/analytics/internal/dispatcher/routing/Router;
...
.method static synthetic access$200(Lcom/upsight/android/analytics/internal/dispatcher/routing/Router;)V
    .locals 0
    .param p0, "x0"    # Lcom/upsight/android/analytics/internal/dispatcher/routing/Router;
...
.method private nextRouteStep(Lcom/upsight/android/analytics/internal/dispatcher/routing/Packet;)V
    .locals 4
    ...
    .line 91
    invoke-virtual {p1}, Lcom/upsight/android/analytics/internal/dispatcher/routing/Packet;->hasMoreOptionsToTry()Z
    ...
    .line 92
    invoke-virtual {p1}, Lcom/upsight/android/analytics/internal/dispatcher/routing/Packet;->routeToNext()Z
    ...
    .line 94
    const-string v0, "Failed to route packet"

    invoke-virtual {p1, v0}, Lcom/upsight/android/analytics/internal/dispatcher/routing/Packet;->failRouteStep(Ljava/lang/String;)V
    ...
    invoke-virtual {p1}, Lcom/upsight/android/analytics/internal/dispatcher/routing/Packet;->getDeliveryHistory()Ljava/lang/String;

    move-result-object v2

    invoke-interface {v0, v1, v3, v3, v2}, Lcom/upsight/android/analytics/internal/dispatcher/routing/RoutingListener;->onDelivery(Lcom/upsight/android/analytics/internal/DataStoreRecord;ZZLjava/lang/String;)V
...
.method public routeEvent(Lcom/upsight/android/analytics/internal/DataStoreRecord;)Z
    ...
    check-cast v0, Lcom/upsight/android/analytics/internal/dispatcher/routing/Route;

    .line 72
    .local v0, "route":Lcom/upsight/android/analytics/internal/dispatcher/routing/Route;
    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lcom/upsight/android/analytics/internal/dispatcher/routing/Route;->getStepsCount()I
    ...
    .line 80
    new-instance v1, Lcom/upsight/android/analytics/internal/dispatcher/routing/Packet;

    new-instance v2, Lcom/upsight/android/analytics/internal/dispatcher/routing/Route;

    invoke-direct {v2, v0}, Lcom/upsight/android/analytics/internal/dispatcher/routing/Route;-><init>(Lcom/upsight/android/analytics/internal/dispatcher/routing/Route;)V

    invoke-direct {v1, p1, v2}, Lcom/upsight/android/analytics/internal/dispatcher/routing/Packet;-><init>(Lcom/upsight/android/analytics/internal/DataStoreRecord;Lcom/upsight/android/analytics/internal/dispatcher/routing/Route;)V

    invoke-direct {p0, v1}, Lcom/upsight/android/analytics/internal/dispatcher/routing/Router;->nextRouteStep(Lcom/upsight/android/analytics/internal/dispatcher/routing/Packet;)V
